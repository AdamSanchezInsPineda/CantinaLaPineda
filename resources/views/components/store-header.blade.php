<header class="mt-5 flex flex-row justify-between">
    <div class=" ml-5 flex flex-row justify-center items-center gap-10">
        <form action="" method="post" class="flex flex-row items-center justify-center gap-3">
            @csrf                
            <input type="text" name="name" id="name" placeholder="Busca tu producto" class="p-2 rounded-full">
    ...
    <div class="mr-5 ml-36 flex flex-row justify-center items-center gap-10">
